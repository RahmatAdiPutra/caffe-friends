	            ...
	            <div class="col-lg-offset-3 col-lg-6">
	              ...
	              <div class="form-group">
	                ...
	                <select class="form-control" id="type" name="type">
						<option value="Food" {{ ( 'Food' == old('type') ) ? 'selected' : '' }}>Food</option>
						<option value="Drink" {{ ( 'Drink' == old('type') ) ? 'selected' : '' }}>Drink</option>
						<option value="Snacks" {{ ( 'Snacks' == old('type') ) ? 'selected' : '' }}>Snacks</option>
					</select>
	              </div>
