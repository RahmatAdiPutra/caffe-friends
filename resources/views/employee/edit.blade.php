	          ...
	          <form method="POST" action="{{ url('/employee/'.$employee['id']) }}">
	            ...
	            <div class="col-lg-offset-3 col-lg-6">
	              <div class="form-group">
	                ...
	                <input type="text" class="form-control" id="name" name="name" placeholder="Employee Name" value="{{ empty(old('name')) ? $employee->name : old('name') }}">
	              </div>
	              ...
	              <div class="form-group">
	                ...
	                <input type="text" class="form-control" id="email" name="email" placeholder="Email" value="{{ empty(old('email')) ? $employee->email : old('email') }}">
	              </div>
